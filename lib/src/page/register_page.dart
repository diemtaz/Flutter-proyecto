...
Future<void> _registerEmailPass() async {
      try {
        
        FirebaseUser resp =  await _userRepository.signUp(email: _email.text,password:_password.text);
        ...
        print("No pudo realizar el registro $error");
      }
    }
